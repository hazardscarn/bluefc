...
print("🚀 Content Agent Engine Deployment (Official Method)")
print("=" * 60)

# Configuration
PROJECT_ID = "energyagentai"
LOCATION = "us-central1"
STAGING_BUCKET = "gs://energyagentai-agent-staging-contentagent"
...
def check_prerequisites():
    ...
    required_files = [
        './contentagent/agent.py',
        './contentagent/requirements.txt',
        './src/qloo.py', 
...
def deploy_with_official_method():
    ...
    try:
        ...
        print("🤖 Importing Content Agent locally...")
        from contentagent.agent import root_agent
        ...
        requirements_file = './contentagent/requirements.txt'
        ...
        extra_packages = [
            "contentagent",  # Include entire merchagent directory
        ...
        gcs_dir_name = f"contentagent-{str(uuid.uuid4())[:8]}"
        ...
        remote_agent = agent_engines.create(
            ...
            requirements=requirements,     # From contentagent/requirements.txt
            ...
            display_name="contentagent",    # Display name
            description="Personalized Content CReation for Chelsea FC fans"
        )
...
def test_deployed_agent(remote_agent):
    ...
    try:
        ...
        # Test query
        test_query = "30 year old Male Chelsea fan from Toronto who likes soccer,plays badminton and loves mediterrenean food..Profession is Senior Data Scientist ..Current favorite players are Cole Palmer and Enzo Fernandez. who like Marvel movies - theme: Chelsea Ready for New Season 2025/26"
        ...
        print("\n✅ contentagent is working correctly!")
        return True
...
def main():
    ...
    print("Starting contentagent deployment using OFFICIAL Agent Engine method")
    print(f"Project: {PROJECT_ID}")
    print(f"Location: {LOCATION}")
    print()
    
    # Check we're in the right directory
    if not os.path.exists('./contentagent') or not os.path.exists('./src'):
    ...
    print(f"2. Find 'contentagent' in the list")
...
if __name__ == "__main__":
    ...
    print("🎯 contentagent → Agent Engine (Official Method)")
    print("=" * 60)
